...
type
  ...
  public
    class function CheckLogin(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function CreateCharacter(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function RequestDeleteChar(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function DeleteChar(var Player: TPlayer; var Buffer: array of BYTE): Boolean; static;
    ...
    class function OpenNPC(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function CloseNPCOption(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateRotation(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateAction(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ChangeGold(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Chat Functions }
    class function SendClientSay(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function SendItemChat(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function PKMode(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function BuyNPCItens(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function SellNPCItens(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    ...
    class function AgroupItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function MoveItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Change Item Atributes [Refine/etc] }
    class function ChangeItemAttribute(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Troca }
    class function TradeRequest(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function TradeResponse(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function TradeRefresh(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function TradeCancel(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Item Bar Functions }
    class function ChangeItemBar(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Mob Functions }
    class function UpdateMobInfo(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Premium Items }
    class function BuyItemCash(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function SendGift(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ReclaimCoupom(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Item Functions }
    class function UseItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UseBuffItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UnsealItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Buff Functions }
    class function RemoveBuff(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Attack & Skill Functions }
    class function UseSkill(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function LearnSkill(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ResetSkills(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function AttackTarget(var Player: TPlayer; var Buffer: array of BYTE; ByUseSkill: Boolean = False): Boolean;
    class function RevivePlayer(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function CancelSkillLaunching(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Friend List }
    class function AddFriendRequest(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function AddFriendResponse(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function DeleteFriend(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Friend Chat }
    class function OpenFriendWindow(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function SendFriendSay(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function CloseFriendWindow(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Ver Char Info }
    class function RequestCharInfo(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Party }
    class function SendParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function AcceptParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function KickParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function DestroyParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function GiveLeaderParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateMemberPosition(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function AddSelfParty(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function PartyAlocateConfig(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Raid }
    class function SendRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function AcceptRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ExitRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function DestroyRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function GiveLeaderRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function RemoveFromRaid(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { PersonalShop }
    class function CreatePersonalShop(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function OpenPersonalShop(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function BuyPersonalShopItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ClosePersonalShop(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Change Channel }
    class function ChangeChannel(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function LoginIntoChannel(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Guild }
    class function CreateGuild(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function CloseGuildChest(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ChangeGuildMemberRank(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateGuildRanksConfig(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateGuildNotices(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function UpdateGuildSite(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function InviteToGuildRequest(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function InviteToGuildAccept(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function InviteToGuildDeny(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function KickMemberOfGuild(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function ExitGuild(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function RequestGuildToAlly(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function ChangeMasterGuild(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Request Time }
    class function RequestServerTime(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestServerPing(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Other Handlers }
    class function GetStatusPoint(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function ReceiveEventItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Duel }
    class function SendRequestDuel(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function DuelResponse(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Quest }
    class function AbandonQuest(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Teleport do FC }
    class function TeleportSetPosition(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Titles }
    class function UpdateActiveTitle(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Pran }
    class function RenamePran(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Mail }
    class function openMail(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function withdrawMailItem(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function checkSendMailRequirements(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    class function sendCharacterMail(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
    { Dungeons }
    class function RequestEnterDungeon(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function DungeonLobbyConfirm(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { MakeItems }
    class function MakeItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RepairItens(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RenoveItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Nation Packets }
    class function UpdateNationGold(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function UpdateNationTaxes(var Player: TPlayer; Buffer: array of BYTE): Boolean;

    { GM Tool Functions }
    class function CheckGMLogin(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMPlayerMove(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMSendChat(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMGoldManagment(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMCashManagment(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMLevelManagment(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMBuffsManagment(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function GMDisconnect(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    ...
    class function RequestAllAttributes(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestAllAttributesTarget(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    { Auction }
    class function RequestAuctionItems(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestRegisterItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestOwnAuctionItems(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestAuctionOfferCancel(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function RequestAuctionOfferBuy(var Player: TPlayer; Buffer: array of BYTE): Boolean;

    { Reliquares }
    class function RequestUpdateReliquare(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function MoveItemToReliquare(var Player: TPlayer; Buffer: array of BYTE): Boolean;

    { Collect Item }
    class function CollectMapItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
    class function CancelCollectMapItem(var Player: TPlayer; Buffer: array of BYTE): Boolean;
  end;
...
begin
  ...
  case Packet.RequestChange of
    ...
    1:
      if AnsiCompareText(Packet.Numeric_1, Trim(Player.Account.Header.NumericToken[Packet.Slot])) = 0 then
      begin
    ...
    2:
      if AnsiCompareText(Packet.Numeric_2, Trim(Player.Account.Header.NumericToken[Packet.Slot])) = 0 then
      begin
        Player.Account.Header.NumericToken[Packet.Slot] := Packet.Numeric_1;
        Player.SaveCharOnCharRoom(Packet.Slot);
        Player.SendToWorld(Packet.Slot);
...
begin
  ...
  begin
    Player.SendClientMessage('Já existe um personagem com esse nome.', 16, 0, 1);
    Exit;
  end;
  ...
  begin
    Player.SendClientMessage('class_id error, try to create your toon again.', 16, 0, 1);
    Exit;
  end;

  ClasseChar := 0;
  if (Packet.ClassIndex >= 10) and (Packet.ClassIndex <= 19) then ClasseChar := 0
  else if (Packet.ClassIndex >= 20) and (Packet.ClassIndex <= 29) then ClasseChar := 1
  else if (Packet.ClassIndex >= 30) and (Packet.ClassIndex <= 39) then ClasseChar := 2
  else if (Packet.ClassIndex >= 40) and (Packet.ClassIndex <= 49) then ClasseChar := 3
  else if (Packet.ClassIndex >= 50) and (Packet.ClassIndex <= 59) then ClasseChar := 4
  else if (Packet.ClassIndex >= 60) and (Packet.ClassIndex <= 69) then ClasseChar := 5;

  if (Packet.Cabelo < 7700) or (Packet.Cabelo > 7731) then Exit;

  Move(InitialAccounts[ClasseChar], Player.Account.Characters[Packet.SlotIndex], sizeof(TCharacterDB));
  Player.Account.Characters[Packet.SlotIndex].Base.Equip[0].Index := Packet.ClassIndex;
  Player.Account.Characters[Packet.SlotIndex].Base.Equip[1].Index := Packet.Cabelo;
  ...
  case ClasseChar of
    2:
      begin
        Player.Account.Characters[Packet.SlotIndex].Base.Equip[15].Index := 4615;
        ...
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].Index := 4615;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].APP := 4615;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].Refi := 1000;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].Index := 4615;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].APP := 4615;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].Refi := 1000;
      end;
    3:
      begin
        Player.Account.Characters[Packet.SlotIndex].Base.Equip[15].Index := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Equip[15].APP := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Equip[15].Refi := 1000;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].Index := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].APP := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[5].Refi := 1000;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].Index := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].APP := 4600;
        Player.Account.Characters[Packet.SlotIndex].Base.Inventory[6].Refi := 1000;
      end;
  end;

  Player.Account.Characters[Packet.SlotIndex].Base.CreationTime := DateTimeToUnix(Now);
  Move(Packet.Name, Player.Account.Characters[Packet.SlotIndex].Base.Name[0], 16);

  case Packet.Local of
    0: Player.Account.Characters[Packet.SlotIndex].LastPos.Create(3450, 690);
    1: Player.Account.Characters[Packet.SlotIndex].LastPos.Create(3470, 935);
  end;

  Logger.Write(string(Player.Account.Header.Username) + ' criou um novo personagem [' + String(Packet.Name) + '].', TLogType.ConnectionsTraffic);
  ...
  PlayerSQLComp := TQuery.Create(AnsiString(MYSQL_SERVER), MYSQL_PORT, AnsiString(MYSQL_USERNAME), AnsiString(MYSQL_PASSWORD), AnsiString(MYSQL_DATABASE));
  if not PlayerSQLComp.Query.Connection.Connected then
  begin
    Logger.Write('Falha de conexão individual com mysql.[CreateCharacter]', TlogType.Warnings);
    Logger.Write('PERSONAL MYSQL FAILED LOAD.[CreateCharacter]', TlogType.Error);
    PlayerSQLComp.Destroy;
    Exit;
  end;

  PlayerSQLComp.SetQuery('select coalesce(av.referrer, "") from account_validate av inner join accounts a on a.mail=av.email WHERE a.id = ' + Player.Account.Header.AccountId.ToString);
  PlayerSQLComp.Run();
...
class function TPacketHandlers.RequestDeleteChar(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
var
...
begin
  ...
  if RecvPacket.Delete then
  begin
    if AnsiCompareText(String(Player.Account.Characters[RecvPacket.SlotIndex].Base.Numeric), String(RecvPacket.Numeric)) <> 0 then
    begin
      Player.SendCharList;
    ...
    if Player.Account.CharactersDelete[RecvPacket.SlotIndex] then
    begin
  ...
  begin
    if String(RecvPacket.Numeric) <> String(Player.Account.Characters[RecvPacket.SlotIndex].Base.Numeric) then
    begin
      Player.SendCharList;
      Player.SendClientMessage('Numerica não correspondente!', 16);
      Exit;
  ...
  if not Player.Account.CharactersDelete[RecvPacket.SlotIndex] then
  begin
    FTime := IncDay(Now, DELETE_DAYS_INC);
    Player.Account.CharactersDelete[RecvPacket.SlotIndex] := True;
    Player.Account.CharactersDeleteTime[RecvPacket.SlotIndex] := DateTimeToStr(FTime);
    Player.SaveCharOnCharRoom(RecvPacket.SlotIndex);
    Player.SendCharList;
    Result := True;
    Exit;
  ...
  FTime := StrToDateTime(String(Player.Account.CharactersDeleteTime[RecvPacket.SlotIndex]));
  if FTime < Now then
  begin
    Player.SendCharList;
    Player.SendClientMessage('Você ainda não pode excluir este personagem!', 16);
    Exit;
  end;
...
class function TPacketHandlers.DeleteChar(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
var
...
begin
  ...
  begin
    if String(RecvPacket.Numeric) <> String(Player.Account.Characters[Slot].Base.Numeric) then
    begin
      Player.SendCharList;
      Player.SendClientMessage('Numerica não correspondente!', 16);
      Exit;
  ...
  if Player.Account.CharactersDelete[Slot] and (String(Player.Account.Characters[Slot].Base.Name) <> '') then
  begin
...
begin
  ...
  if Player.Base.PlayerCharacter.LastPos.Distance(Player.Character.LastPos) >= 3 then
  begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if NewPranPosition.Distance(Player.Account.Header.Pran1.Position) >= 2 then
        begin
    ...
    begin
      ...
      begin
        Randomize;
        NewPranPosition := Player.Base.Neighbors[Random(7)].pos;
        if NewPranPosition.Distance(Player.Account.Header.Pran2.Position) >= 2 then
        begin
...
begin
  ...
  begin
    Player.SendClientMessage('Você não pode ligar o PvP em duelo.');
    Result := False;
    Exit;
  end;

  Player.Character.PlayerKill := IFThen(Packet.Data = 1, True, False);
  Player.Base.PlayerCharacter.PlayerKill := Player.Character.PlayerKill;
  Player.Base.SendToVisible(Packet, Packet.Header.Size);
  Result := True;
end;

class function TPacketHandlers.UpdateRotation(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
var
  Packet: TSignalData absolute Buffer;
begin
...
class function TPacketHandlers.UpdateAction(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
var
...
class function TPacketHandlers.ChangeGold(var Player: TPlayer; var Buffer: array of BYTE): Boolean;
var
  ...
  case Packet.ChestType of
      ...
      begin
        ...
        begin
          if Player.Character.Base.Gold < Packet.Value then
            Exit;
          if Player.Account.Header.Storage.Gold + Packet.Value > 2000000000 then
          begin
            Player.SendClientMessage('Gold máximo: 2000000000.');
            Exit;
          end;
        end;
        Player.Account.Header.Storage.Gold := Player.Account.Header.Storage.Gold + Packet.Value;
        Player.Character.Base.Gold := Player.Character.Base.Gold - Packet.Value;
        Player.RefreshMoney;
    ...
    GUILDCHEST_TYPE:
      begin
        ...
        if Guild.MemberInChest <> Guild.FindMemberFromCharIndex(Player.Character.Index) then
          Exit;
        Guild.LastChestActionDate := Now;
        if not Guild.GetRankConfig(Guild.Members[Guild.FindMemberFromCharIndex(Player.Character.Index)].Rank).UseGWH then
        begin
  ...
  case Packet.TypeChat of
    CHAT_TYPE_NORMAL:
      begin
        ...
        begin
          HandleArchonChat(Player, Packet, strAux);
        end
        else
        begin
          Player.Base.SendToVisible(Packet, Packet.Header.Size);
...
procedure HandleArchonChat(var Player: TPlayer; var Packet: TChatPacket; var strAux: String);
var
  I, j: Integer;
begin
  ...
  begin
    ...
    if (Nations[Player.Base.Character.Nation-1].TacticianGuildID = Guilds[Player.Character.GuildSlot].Index) then
      Packet.NotUse[0] := 1;

    if (Nations[Player.Base.Character.Nation-1].JudgeGuildID = Guilds[Player.Character.GuildSlot].Index) then
      Packet.NotUse[0] := 2;

    if (Nations[Player.Base.Character.Nation-1].TreasurerGuildID = Guilds[Player.Character.GuildSlot].Index) then
      Packet.NotUse[0] := 3;
    ...
    begin
      ...
      begin
        if (Servers[I].Players[j].Status < Playing) then
          Continue;
        if ((Servers[I].Players[j].Base.Character.Nation = Player.Base.Character.Nation) and
          not(Servers[I].Players[j].Base.Character.Nation = 0)) then
        begin
          Servers[I].Players[j].SendPacket(Packet, Packet.Header.Size);
        end;
